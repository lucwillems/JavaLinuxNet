...
#include "org_it4y_net_TProxyServerSocket.h"
 ...
 */
JNIEXPORT jint JNICALL Java_org_it4y_net_TProxyServerSocket_setIPTransparant(JNIEnv *env, jobject this, jint fd) {
...
JNIEXPORT jint JNICALL Java_org_it4y_net_TProxyServerSocket_getOriginalDestination(JNIEnv *env, jobject this, jint fd) {
